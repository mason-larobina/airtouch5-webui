//! In-memory mock AirTouch 5 controller for e2e tests and the `airtouch5-webui-mock`
...
/// static mockup. Handy for the `airtouch5-webui-mock` binary and as a test fixture.
